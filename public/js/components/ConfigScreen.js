...
import { generateId, getCategories, groupByCategory } from '../utils.js';
...
function TrackerForm({ tracker, onSave, onCancel }) {
    ...
    const handleSubmit = (e) => {
        ...
        console.log('useNewCategory:', useNewCategory);
        ...
        console.log('Calling onSave with:', trackerData);
        onSave(trackerData);
    };
...
export function ConfigScreen() {
    ...
    const handleSave = (trackerData) => {
        console.log('handleSave called with:', trackerData);
        if (editTracker) {
            updateTracker(editTracker.id, trackerData);
        } else {
            addTracker(trackerData);
        }
        console.log('Tracker added, closing form');
        setShowForm(false);
        setEditTracker(null);
    };
